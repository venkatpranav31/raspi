...
class HWInterfaceNode(Node):
    def __init__(self):
        ...
        self.pub_rear_left_ticks = self.create_publisher(Int64, '/rear_left_ticks', 10)
        self.pub_rear_right_ticks = self.create_publisher(Int64, '/rear_right_ticks', 10)
    ...
    def main_loop(self):
        output_string = f"<{int(self.rear_left_w * self.max_speed)},{int(self.rear_right_w * self.max_speed)}>"
        ...
        try:
            ...
            self.pub_rear_left_ticks.publish(Int64(data=ticks[0]))
            self.pub_rear_right_ticks.publish(Int64(data=ticks[1]))
        except ValueError:
